...
<div class="content">
    <div align="center">
        ...
        <center>
            ...
            <p style="color: black; font-size: 150%; font-weight: bold;">SORGU RAPORU</p>
        </center>
        ...
        <table style="font-family: Arial; width: 100%;">
            <tr>
                <td valign="top" style="border-top:1px solid #111;border-right:1px solid #111;border-left:1px solid #111;border-bottom:1px solid #111;padding:3px;padding-left:6px;margin:1px;border-radius:2px"><strong class="text-strong">SORGUYU ALAN MEMUR</strong></td>
        ...
        <table style="font-family: Arial; width: 100%;">
            <tr>
                <td valign="top" style="border-top:1px solid #111;border-right:1px solid #111;border-left:1px solid #111;border-bottom:1px solid #111;padding:3px;padding-left:6px;margin:1px;border-radius:2px"><strong class="text-strong">SORGU</strong></td>
            </tr>
            <tr>
